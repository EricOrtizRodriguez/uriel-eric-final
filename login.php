                    ...
                    <div  class="col-md-6">
                        <div class="header-top-menu">
                            <ul class="nav nav-pills navbar-right">
                                ...
                                <li><a href="logi.php"><i class="pe-7s-lock"></i>Login</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                          ...
                          <form name="login" method="post" action="loginv.php">
                       <link rel="stylesheet" href="estilos.css">

                          <br>USUARIO<br> <input type="text" name="usuario" id="usuario" />
                          <br>PASSWORD<br> <input type="password" name="clave" id="clave" />

                       <br><br><input type="submit" name="Submit" value="Iniciar Sesion" />

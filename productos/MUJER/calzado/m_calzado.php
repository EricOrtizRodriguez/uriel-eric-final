...
echo '<script>window.location="m_calzado.php"</script>';
}
}
}
}
...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <section class="new-section">
          ...
          <td><a href="m_calzado.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Eliminar</span></a></td>
          </tr>
          <?php

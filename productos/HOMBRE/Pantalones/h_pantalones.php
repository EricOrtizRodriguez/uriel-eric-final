...
echo '<script>window.location="h_pantalones.php"</script>';
}
}
}
}
...
<html class="no-js" lang="en">
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInRight animated" data-wow-delay="0.4s">
                        <div class="service-item">
                          ...
                          <a href="../sudaderas/h_sudaderas.php">
                            <h3>SUDADERAS</h3>
                          </a>
        ...
        <section class="new-section">
          ...
          <?php
          $query = "SELECT * FROM h_pantalones ORDER BY id ASC";
          ...
          <td><a href="h_pantalones.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Eliminar</span></a></td>
          </tr>
          <?php

...
echo '<script>window.location="h_camisas.php"</script>';
}
}
}
}
...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <section class="new-section">
          ...
          <?php
          $query = "SELECT * FROM h_camisas ORDER BY id ASC";
          ...
          <td><a href="h_camisas.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Eliminar</span></a></td>
          </tr>
          <?php

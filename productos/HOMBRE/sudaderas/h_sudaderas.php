...
echo '<script>window.location="h_sudaderas.php"</script>';
}
}
}
}
...
<html class="no-js" lang="en">
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInRight animated" data-wow-delay="0.2s">
                        <div class="service-item">
                          ...
                          <a href="../pantalones/h_pantalones.php">
                            <h3>PANTALONES</h3>
                          </a>
                        </div>
                    </div>
        ...
        <section class="new-section">
          ...
          <?php
          $query = "SELECT * FROM h_sudaderas ORDER BY id ASC";
          ...
          <td><a href="h_sudaderas.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Eliminar</span></a></td>
          </tr>
          <?php

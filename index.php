...
<html class="no-js" lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInLeft animated" data-wow-delay="0.8s">
					 ...
					 <div class="col-md-3 col-sm-6 wow fadeInLeft animated" data-wow-delay="0.8s">
                        <div class="product-item">
                            <img src="images/PROXIMAMENTE.png" class="img-responsive" width="255" height="322" alt="">

                            <div class="product-title">

                                    <h3>UTILILIZA LAYAR PARA VER OTROS ARTICULOS</h3>
		...
		<section class="service-section">
            <div class="container">
                <div class="row">
                <h2>  UTILIZA LAYAR PARA VER MAS DE LOS PROXIMOS ARTICULOS</h2><BR><BR><BR><BR>
				<CENTER>
				<img src="images/PROXIMAMENTE.png" class="img-responsive" width="805" height="472" alt="">
				</CENTER><BR><BR><BR><BR>
                    </div>
                </div>
            </div>
